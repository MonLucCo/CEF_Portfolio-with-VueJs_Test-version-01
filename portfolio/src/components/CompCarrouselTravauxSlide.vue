...
<script>
import CompPresentationSlide from "./CompPresentationSlide.vue";
export default {
  components: {
    CompPresentationSlide,
  },
  data() {
    return {
      slides: [
